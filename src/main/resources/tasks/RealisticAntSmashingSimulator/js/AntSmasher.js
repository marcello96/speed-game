...
var config_endpoint = "/RealisticAntSmashingSimulator/config";
var postScore_endpoint = "/RealisticAntSmashingSimulator/end";

getJSON(config_endpoint, afterConfigFetched);

function preload() {
    if (!debug) {
        antImg = loadImage('img/ant.png');
        waspImg = loadImage('img/wasp.png');
    }
}
